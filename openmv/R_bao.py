...
green_threshold = (18, 31, -16, 20, -20, 13)
...
while(True):
    ...
    if red_blobs:
        for blob in red_blobs:
            max_red_blob = max(red_blobs,key=lambda r_b:r_b.pixels()) # 找到最大红色色块
            # 在图像中画出最大红色色块的矩形框和中心点
        ...
        if yellow_blobs:
            ...
            for blob in yellow_blobs:
                ...
                img.draw_rectangle(max_yellow_blob.rect())# 在图像中画出最大黄色色块的矩形框
                # 获取矩形框的位置和大小
